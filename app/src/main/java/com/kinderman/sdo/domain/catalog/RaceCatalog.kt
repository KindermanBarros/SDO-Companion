...
object RaceCatalog {
    ...
    private fun power(
        ...
        executionType = if (costValue > 0 || action != "Passiva") com.kinderman.sdo.domain.model.AbilityExecution.ACTION else com.kinderman.sdo.domain.model.AbilityExecution.PASSIVE,
        rangeType = when {
    ...
    val races = listOf(
        race("Skayra", "POD", 1, 1, 2, 0, powers = arrayOf(power("Sombra Autônoma", "Interaja com um objeto ou mecanismo simples a até 5 m pela sombra.", costValue = 1, range = "5 metros"), power("Marca do Pacto", "Uma vez por cena, receba +4 em Proteção Mental ou Arcana.", costValue = 2, limit = "Uma vez por cena"))),
        race("Humanos", "Qualquer", 1, 1, 1, 1, powers = arrayOf(power("Versatilidade", "Escolha 1 Conhecimento Adquirido adicional."), power("Adaptação", "Uma vez por cena, repita um teste falho e mantenha o segundo resultado.", costValue = 2, limit = "Uma vez por cena"))),
        ...
        race("Ascendidos", "VIG", 2, 0, 1, 1, powers = arrayOf(power("Asas Manifestas", "Plane, ignore quedas ou voe 10 m, terminando apoiado.", costValue = 2), power("Sopro Dracônico", "Uma vez por cena, afete uma linha de 6 m com POD + Arcano e cause 1d6 de dano mágico.", costValue = 2, limit = "Uma vez por cena"))),
        ...
        race("Ciuvati", "POD", 0, 2, 2, 0, powers = arrayOf(power("Anatomia Impossível", "Uma vez por cena, reduza em um grau uma Falha Corporal, mutilação ou desmembramento.", costValue = 2, limit = "Uma vez por cena", action = "1 ação"), power("Presença Anômala", "Uma vez por cena, faça um teste resistido; o alvo sofre -2 contra você até o próximo turno.", costValue = 3, limit = "Uma vez por cena"))),
        ...
        race("Sonaris", "POD", 0, 2, 1, 1, powers = arrayOf(power("Tímpano Vivo", "+5 em Sentidos por audição e localização sonora em 10 m; vulnerável a som extremo.", action = "1 ação"), power("Memória Emocional", "Capte a impressão emocional mais forte de um objeto ou local.", costValue = 2))),
        ...
        race("Fadas", "CAR", 0, 2, 2, 0, powers = arrayOf(power("Voo Feérico", "Voe 10 m e termine apoiado.", costValue = 2), power("Glamour", "Uma vez por cena, crie uma ilusão sensorial simples em uma área de 5 m.", costValue = 2, limit = "Uma vez por cena"))),
        race("Sangue-Vil", "Qualquer", 1, 0, 2, 1, powers = arrayOf(power("Herança", "Ao acertar, cause +1d6 de dano mágico do tipo definido na criação.", costValue = 1, action = "1 ação"), power("Olhar Amaldiçoado", "Uma vez por cena, tente intimidar até 3 criaturas adicionando POD.", costValue = 4, limit = "Uma vez por cena"))),
    ...
    val subRaces = listOf(
        SubRaceDefinition("Oráculo", listOf(
            power("Vislumbre do Possível", "Uma vez por cena, rerrole o d20 e escolha o resultado.", costValue = 2, destinyCostEligible = true, limit = "Uma vez por cena"),
            power("Presságio", "Uma vez por cena, aplique +2 ou -2 ao primeiro teste de uma criatura.", costValue = 2, destinyCostEligible = true, limit = "Uma vez por cena"),
        ...
        SubRaceDefinition("Bestial — Completo", listOf(
            ...
            power("Couraça Dominante", "Uma vez por cena, aumente para RD 4 a resistência contra o ataque do tipo escolhido.", costValue = 2, limit = "uma vez por cena"),
