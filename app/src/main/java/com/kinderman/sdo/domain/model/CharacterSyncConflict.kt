 ...
 * the most recently written document wins together. Equal timestamps preserve the local copy,
 * avoiding the loss of an edit made at the same instant as the online write.
