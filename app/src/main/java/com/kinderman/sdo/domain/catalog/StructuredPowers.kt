...
fun CatalogEntry.toStructuredPower(
    ...
    activationCondition = "Conforme as condições descritas no efeito",
    enhancements = extractEnhancement(summary).ifBlank { "Sem aprimoramento publicado" },
    deactivationCondition = "Quando deixar de atender às condições da fonte e do efeito",
