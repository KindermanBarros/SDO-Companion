...
/** Code-native assets for the experimental Kaltoch terminal interface. */
@Composable
internal fun KaltochBackdrop(modifier: Modifier = Modifier) {
...
@Composable
internal fun BoxScope.KaltochEdgeMarks() {
    Text(
        "SIGNAL//UNSTABLE  ◉  REC",
...
@Composable
internal fun KaltochPanelChrome() {
    Row(
...
fun SdoScreenMasthead(
    ...
    if (LocalSdoPreferences.current.visualMode != SdoVisualMode.KALTOCH) {
