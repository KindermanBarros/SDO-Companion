# Interface Kaltoch — direção experimental

## Objetivo

A Interface Kaltoch é uma apresentação alternativa do SDO Companion para celulares. Ela deve parecer
...
A Interface Padrão continua sendo a experiência estável. A Interface Kaltoch aparece logo abaixo dela
nas configurações, marcada pelo selo amarelo **EXPERIMENTAL**. Enquanto a Interface Kaltoch estiver
...
A experiência padrão não assume esse custo. A Interface Kaltoch é opt-in e identificada como
experimental.
